...
# 1. 核心設定與初始化
# ==========================================
st.set_page_config(page_title="當沖雷達 - 自動修復版", layout="wide")
...
# ==========================================
# 2. 自動字體解決方案 (徹底解決 Unknown Format)
# ==========================================
def get_fonts():
    # 改用 .otf 格式，這是 Linux 環境相容性最高的格式
    ...
    if need_download:
        try:
            with st.spinner("首次啟動或字體異常，正在自動下載中文字體..."):
