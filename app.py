...
# 1. 核心初始化
# ==========================================
st.set_page_config(page_title="當沖雷達 - 基準總量全移植版", layout="wide")
...
if st.session_state.running:
    ...
    st.info(f"當前量能基準門檻：{target_threshold} (時段系數:{vol_base})")
    ...
    for s in snaps:
        ...
        # 基準判斷 C: 量增倍率 (當前總量 / 昨日量) 必須大於 動態基準
