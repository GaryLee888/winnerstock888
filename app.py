...
try:
    ...
    st.error("❌ 找不到 Secrets 設定！請在 Settings -> Secrets 填入正確的金鑰與網址。")
    st.stop()

st.set_page_config(page_title="當沖雷達-生產穩定版", layout="wide")
...
if st.session_state.state['running']:
    ...
    targets = targets[:600] # 平衡雲端負載與偵測深度
